<template>
    <div>
        <div class="text-xl md:text-3xl suzuki-bold text-gray-900 mb-5"> Book A Test Drive</div>
            ...
            <ValidationObserver v-else v-slot="{ invalid,passes }">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-10">
                    <div class="lg:col-span-2">
                        <div class="block text-lg font-medium text-gray-800 mb-2">Select a model to test drive</div>
                    ...
                    <div>
                        <ValidationProvider name="form.emirate" rules="required">
                            <div slot-scope="{ errors }">
