        ...
        <div class="text-xl md:text-3xl suzuki-bold text-gray-900 mb-5">Get A Quote</div>
            <ValidationObserver v-slot="{ invalid,passes }">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-10">
                    ...
                    <div>
                        <ValidationProvider name="form.ptype" rules="required">
                            <div slot-scope="{ errors }">
                                <multiselect v-model="form.ptype" :options="ptypes" placeholder="Purchase Type *"></multiselect>
