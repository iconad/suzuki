                ...
                <li class="nav-link mr-3 relative">
                    ...
                    <ul class="text-sm nav-list sc1240:absolute left-0 top-100 flex flex-col sc1240:flex-row items-start sc1240:items-center bg-theme-red-500 text-white w-auto whitespace-nowrap">
                        <li class="nav-link relative">
                            <a href="/after-sales/services" class="block p-2">I want To</a>
                            <ul class="nav-list sc1240:absolute uppercase italic font-bold left-0 top-100 flex flex-col sc1240:flex-row items-start sc1240:items-center bg-gray-300 text-gray-800 w-64 sc1240:w-auto whitespace-nowrap">
                                <li class="nav-link">
                                    <a href="/after-sales/warranty" class="block p-2">Book a Service</a>
                                </li>
                                <li class="nav-link">
                                    <a href="/after-sales/service-payment-plan" class="block p-2">Find Work Shop Location</a>
                                </li>
                                <li class="nav-link">
                                    <a href="/after-sales/book-service" class="block p-2">Check Recall</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-link">
                        ...
                        <li class="nav-link relative">
                            ...
                            <ul class="nav-list sc1240:absolute uppercase italic font-bold left-0 top-100 flex flex-col sc1240:flex-row items-start sc1240:items-center bg-gray-300 text-gray-800 w-64 sc1240:w-auto whitespace-nowrap">
                                <li class="nav-link">
                                    <a href="/after-sales/warranty" class="block p-2">Suzuki Owner Special offer</a>
                                </li>
                                <li class="nav-link">
                                    <a href="/after-sales/service-payment-plan" class="block p-2"> Value added services</a>
                                </li>
                                <li class="nav-link">
                                    <a href="/after-sales/book-service" class="block p-2">Body shop Repair</a>
                                </li>
                                <li class="nav-link">
                                    <a href="/after-sales/book-service" class="block p-2">Suzuki Service FAQ</a>
                                </li>
                                <li class="nav-link">
                                    <a href="/after-sales/book-service" class="block p-2">Suzuki Tips and Advices</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-link">
