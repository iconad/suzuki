<template>
    <div>
        ...
        <transition name="slide-fade">
            <div
            v-if="isSidebar"
            class="right-0 sidebar fixed top-0 h-full w-35rem z-10 bg-gray-100 flex items-center justify-center pl-8 pr-24 border-gray-300 border-l-2 transition ease-out duration-300">
    ...
    <div v-if="isBodyOverlay" class="body-overlay" @click="clearEverything"></div>
...
<script>
    ...
    import FinancialCalculator from '../vehicle/sidebars/FinancialCalculator'
    export default {
        components: {
            FinancialCalculator,
