...
<td style="padding-bottom: 20px; background-color: #ffffff; height: 66px;" valign="top">Hello {{$title}} {{$name}} ,<br /><br />We have successfully received your message, our team member will contact you as soon as posible. below is your information</td>
</tr>
...
<tr>
    <td colspan="2" class="data-heading" width="150" style="text-align: left;">Message</td>
</tr>
<tr>
    <td colspan="2" class="data-value" width="100%" style="text-align: left;">{{$bodyMessage}}</td>
</tr>
</tbody>
</table>
</td>
