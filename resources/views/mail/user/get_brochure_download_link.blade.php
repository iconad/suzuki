...
<td style="padding-bottom: 20px; background-color: #ffffff; height: 66px;" valign="top">Hello {{$name}},<br /><br />You are reciving this email becouse you signup for brochure download. below are the download links for your requested models.</td>
</tr>
...
<tbody>
    ...
    <tr>
        ...
        <td class="data-value"> <a href="{{$file['pdf']}}" target="_blank" download>Download Brochure</a> </td>
    </tr>
    @endforeach
</tbody>
</table>
