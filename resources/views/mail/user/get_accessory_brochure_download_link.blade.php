...
<td style="padding-bottom: 20px; background-color: #ffffff; height: 66px;" valign="top">Hello {{$name}},<br /><br />You are reciving this email becouse you requested {{$model}} accessories brochure. below is the download link.</td>
</tr>
