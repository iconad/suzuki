...
<td style="padding-bottom: 20px; background-color: #ffffff; height: 66px;" valign="top">Hello {{$title}} {{$name}},<br /><br />We have recived you quote for the geniune part. Shortly you will get a call from one of our memeber</td>
</tr>
...
<tbody>
<tr>
<td style="background-color: gray; text-align: center; padding: 10px; color: white;">Your Information</td>
</tr>
<tr>
...
<tr>
    ...
    <td class="data-value"> {{$title}} {{$name}}</td>
</tr>
<tr>
...
<tr>
    <td class="data-heading" width="150">Part</td>
    <td class="data-value">{{$part}}</td>
</tr>
<tr>
    <td class="data-heading" width="150">Car Registration & VIN Number</td>
    <td class="data-value">{{$vin}}</td>
</tr>
<tr>
    <td class="data-heading" width="150">Emirate</td>
...
<td style="padding-top: 20px; background-color: #ffffff; height: 44px;">See you soon!<br />Suzuki UAE</td>
</tr>
</tbody>
</table>
</td>
