...
<tbody>
<tr>
<td class="header-cell" valign="top"><img src="http://127.0.0.1:8000/assets/images/logo.png" alt="logo" width="196" height="auto" /></td>
</tr>
<tr>
...
<td style="padding-bottom: 20px; background-color: #ffffff; height: 66px;" valign="top">Hello {{$name}},<br /><br />You are reciving this email becouse you signup for specsheet download. below are the download links for your requested models.</td>
</tr>
...
<tbody>
<tr>
<td style="background-color: gray; text-align: center; padding: 10px; color: white;">Download Links</td>
</tr>
<tr>
...
<tbody>
    ...
    <tr>
        ...
        <td class="data-value"> <a href="{{$file['pdf']}}" target="_blank" download>Download Specsheet</a> </td>
    </tr>
    @endforeach
</tbody>
</table>
...
<td style="padding-top: 20px; background-color: #ffffff; height: 44px;">Thank You!<br />Suzuki UAE</td>
</tr>
</tbody>
</table>
</td>
