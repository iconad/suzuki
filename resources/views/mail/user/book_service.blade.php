...
<td style="padding-bottom: 20px; background-color: #ffffff; height: 66px;" valign="top">Hello {{$title}} {{$name}},<br /><br />We have recived you request for the test drive. Shortly you will get a call from one of our memeber</td>
</tr>
