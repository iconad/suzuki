...
<td style="padding-bottom: 20px; background-color: #ffffff; height: 66px;" valign="top">Hello Team,<br /><br />A new user request finance  quotation for {{$vehicle}} on Suzuki.ae</td>
</tr>
...
<tr>
  <td class="data-heading" width="150">Vehicle</td>
  <td class="data-value">{{$vehicle}}</td>
</tr>
<tr>
  <td class="data-heading" width="150">Deposit</td>
  <td class="data-value">{{$deposit}}</td>
</tr>
<tr>
  <td class="data-heading" width="150">Duration</td>
  <td class="data-value">{{$duration}}</td>
</tr>
<tr>
  <td class="data-heading" width="150">Price</td>
  <td class="data-value">{{$price}}</td>
</tr>
<tr>
  <td class="data-heading" width="150">Total Interest</td>
  <td class="data-value">{{$total_interest}}</td>
</tr>
<tr>
  <td class="data-heading" width="150">Total Payable</td>
  <td class="data-value">{{$total_payable}}</td>
</tr>
<tr>
  <td class="data-heading" width="150">Interest Rate</td>
  <td class="data-value">{{$interest_rate}}</td>
</tr>
</tbody>
</table>
</td>
