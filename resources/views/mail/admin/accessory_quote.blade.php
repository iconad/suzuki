...
<td style="padding-bottom: 20px; background-color: #ffffff; height: 66px;" valign="top">Hello Team,<br /><br />A new quoatatin request for {{$model}}'s accessory. </td>
</tr>
...
<table width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
    <tbody>
        ...
        <tr>
            <td colspan="2" class="data-heading">
                <center>Cart</center>
            </td>
        </tr>
        ...
        <tr>
            <td colspan="2" class="data-heading">
                <center>Item #{{$key+1}}</center>
            </td>
        </tr>
        <tr>
            <td class="data-heading">Vehicle</td>
            <td class="data-value">{{$item->vehicle}}</td>
        </tr>
        <tr>
            <td class="data-heading">Accessory</td>
            <td class="data-value">{{$item->accessory}}</td>
        </tr>
        <tr>
            <td class="data-heading">SKU</td>
            <td class="data-value">{{$item->sku}}</td>
        </tr>
        @endforeach
    </tbody>
</table>
