        ...
        <div class="absolute inset-0 bg-black bg-opacity-25">
            <div class="md:max-w-screen-xl mx-auto px-5 xxl:px-0 text-gray-800 flex items-end h-full pb-8 md:pb-16 xxl:pb-32">
                <h1 class="suzuki-bold leading-none md:leading-12">
                    <span class="text-3xl md:text-5xl lg:text-6xl uppercase block text-white">Services</span>
                </h1>
            </div>
        </div>
    </div>
    ...
    <div class="md:max-w-screen-xl mx-auto px-5 xxl:px-0 text-gray-800">
        <div class="w-full space-y-10">
            ...
            <div class="content text-lg">
                <h2 class="text-3xl suzuki-bold uppercase text-theme-skyblue">SERVICE</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
                <div class="relative overflow-hidden">
                    <img src="{{asset('assets/images/service/service1.png')}}" alt="box" class="h-full object-cover hover:scale-105 transform transition ease-out duration-300 w-full">
                    <div class="absolute top-0 right-0 p-3">
                        <div class="suzuki-bold text-white text-2xl text-shadow-overlay">FLEXIBLE</div>
                    </div>
                </div>
                {{-- item --}}
                <div class="relative overflow-hidden">
                    <img src="{{asset('assets/images/service/service4.png')}}" alt="box" class="h-full object-cover hover:scale-105 transform transition ease-out duration-300 w-full">
                ...
                {{-- item --}}
                <div class="relative overflow-hidden">
                    <img src="{{asset('assets/images/service/service2.png')}}" alt="box" class="h-full object-cover hover:scale-105 transform transition ease-out duration-300 w-full">
                    <div class="absolute bottom-0 right-0 p-3">
                        <div class="suzuki-bold text-white text-2xl text-shadow-overlay">WHAT INCLUDED?</div>
                    </div>
                </div>
                {{-- item --}}
                <div class="relative overflow-hidden">
                    <img src="{{asset('assets/images/service/service3.png')}}" alt="box" class="h-full object-cover hover:scale-105 transform transition ease-out duration-300 w-full">
